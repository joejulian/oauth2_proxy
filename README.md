...
[![pipeline status](https://gitlab.com/jj-ff/joejulian_oauth2_proxy/badges/master/pipeline.svg)](https://gitlab.com/jj-ff/joejulian_oauth2_proxy/commits/master)
...
1. Download [Prebuilt Binary](https://github.com/joejulian/oauth2_proxy/releases) (current release is `v2.2`) or build with `$ go get github.com/joejulian/oauth2_proxy` which will put the binary in `$GOROOT/bin`
